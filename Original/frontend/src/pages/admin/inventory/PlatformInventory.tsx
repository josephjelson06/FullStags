  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">Platform Inventory</h1>
        <div className="text-sm text-gray-500">{items.length} total items</div>
      </div>
      ...
      <input
        ...
        className="w-full rounded-lg border border-gray-300 px-4 py-2 text-sm dark:border-gray-600 dark:bg-gray-800"
      />
